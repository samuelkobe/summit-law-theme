						...
						<a class="group text-green-deep text-2xl xl:text-3xl no-underline hover:underline" href="<?php echo esc_url( get_permalink( $selected_post->ID ) ); ?>">
							<?php if ( has_post_thumbnail( $selected_post->ID ) ) : ?>
								<div class="triple-card__wrapper mb-4 md:w-[80%] relative">
									<div class="triple-card__image aspect-[4/5] overflow-hidden rounded-lg shadow-md lg:group-hover:shadow-xl lg:group-hover:-translate-y-1 lg:group-hover:scale-[1.025] transition-all duration-500">
										<?php echo get_the_post_thumbnail( $selected_post->ID, 'full', array( 'class' => 'w-full h-auto' ) ); ?>
									</div>
