...
<section id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $classes ); ?> bg-green-deep py-16 lg:py-24">
	<div class="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-4 px-4 lg:px-0 items-center">
		<div class="col-span-1 lg:col-start-2 lg:col-span-4 flex flex-col items-start p-4">
