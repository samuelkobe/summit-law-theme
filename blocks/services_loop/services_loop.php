	...
	<div class="container mx-auto px-6">
		...
		if ( $service_types ) :
			foreach ( $service_types as $service_type ) : ?>
				...
				<div class="service-type grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12 lg:mb-24 2xl:mb-32 last:mb-0">

					<!-- <div class="hidden lg:block bg-green-accent1/30 min-h-[50px]"></div>
					<div class="hidden lg:block bg-green-accent2/70 min-h-[50px]"></div>
					<div class="hidden lg:block bg-green-accent1/30 min-h-[50px]"></div>
					<div class="hidden lg:block bg-green-accent2/70 min-h-[50px]"></div>
					<div class="hidden lg:block bg-green-accent1/30 min-h-[50px]"></div>
					<div class="hidden lg:block bg-green-accent2/70 min-h-[50px]"></div>
						...
						<h2>
							<a class="group text-green-deep text-2xl md:text-3xl 2xl:text-4xl no-underline hover:underline" href="<?php echo esc_url( get_permalink( $service_type->ID ) ); ?>">
								<div class="inline-flex items-start gap-2">
									...
									<span class="lg:w-48 font-museum decoration-[2.5px] underline underline-offset-4 decoration-transparent group-hover:decoration-green-deep transition-colors duration-300"><?php echo esc_html( get_the_title( $service_type->ID ) ); ?></span>
								</div>
							</a>
						</h2>
					...
					if ( $practice_areas ) : ?>
						<ul class="practice-areas col-span-1 lg:col-start-6 lg:col-span-6 text-lg leading-8 xl:text-xl xl:leading-9 2xl:text-xl 2xl:leading-10 font-normal list-none">
							<?php foreach ( $practice_areas as $area ) : ?>
								<li class="relative font-normal text-lg md:text-xl 2xl:text-3xl border-b-2 border-b-brand-30 group">
